...
public class LuckController {
    ...
    private static int cardNum = 0;
        ...
        public static LuckCard[] LuckCards = {
            ...
            //Ryk frem/tilbage
/*0*/       new LuckCard("Move", "Ryk frem til START", 1),
            ...
            new LuckCard("Move", "Ryk frem til Frederiksberg Allé. Hvis De passerer START indkasser KR. 4000.", 11, 3), // Passerer start hvis man lader på Lykke felt nr. 3 eller over.
/*5*/       new LuckCard("MoveToShip", "Tag med den nærmeste færge - Flyt brikken frem, og hvis De passerer START indkasser da KR. 4000.", 0, 6), // Passerer start hvis man lader på Lykke felt nr. 6.
...
/*10*/      new LuckCard("Pay","Betal 3000KR for reparation af deres vogn",3000),
...
/*15*/      new LuckCard("Receive","De har vundet i Klasselotteriet. Modtag  500 KR.", 500),
...
/*20*/      new LuckCard("Receive","De havde enrække med elleve rigtige i tipning. Modtag 1000 KR.", 1000),
